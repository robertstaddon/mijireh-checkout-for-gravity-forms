...
class GFMijirehCheckoutData{

    public static function update_table(){
        global $wpdb;

        $table_name = self::get_mijireh_checkout_table_name();
    ...
    public static function insert_transaction($entry_id, $transaction_type, $transaction_id, $parent_transaction_id, $amount){
        global $wpdb;
        ...
        if(!$existing_transaction_id){
            ...
            $sql = $wpdb->prepare(" INSERT INTO $table_name (entry_id, transaction_type, transaction_id, parent_transaction_id, amount, is_renewal, date_created)
                                    values(%d, %s, %s, %s, %f, %d, utc_timestamp())", $entry_id, $transaction_type, $transaction_id, $parent_transaction_id, $amount, $is_renewal);
    ...
    public static function get_mijireh_checkout_table_name(){
        global $wpdb;

        return $wpdb->prefix . "rg_mijireh_checkout";
    }

    public static function get_transaction_table_name(){
        global $wpdb;

        return $wpdb->prefix . "rg_mijireh_checkout_transaction";
    }
    ...
    public static function get_feed_by_form($form_id, $only_active = false){
        ...
        return apply_filters("gform_mijireh_checkout_get_feeds_{$form_id}", apply_filters('gform_mijireh_checkout_get_feeds', $results, $form_id), $form_id);
    }
    ...
    public static function drop_tables(){
        ...
        $wpdb->query("DROP TABLE IF EXISTS " . self::get_mijireh_checkout_table_name());
    }
